...
data_complete <- read.csv("P:/15022000_egenutvikling_trond_simensen/Spatial_regression/Tomtereserver_analyse/holiday_homes/holiday_home_data.csv", 
...
data <- read.csv("P:/15022000_egenutvikling_trond_simensen/Spatial_regression/Tomtereserver_analyse/holiday_homes/mountain_data.csv", 
	header = TRUE, sep = ",", encoding = "latin") |> as_tibble()
...
z_data <- read.csv("P:/15022000_egenutvikling_trond_simensen/Spatial_regression/Tomtereserver_analyse/holiday_homes/z_mountain_data.csv", 
	header = TRUE, sep = ",", encoding = "latin") |> as_tibble()
...
# proportions are logit-transformed, and all responses finally transformed to z-scores
zs_data <- read.csv("P:/15022000_egenutvikling_trond_simensen/Spatial_regression/Tomtereserver_analyse/holiday_homes/zs_mountain_data.csv", 
	header = TRUE, sep = ",", encoding = "latin") |> as_tibble()
...
#   file = "P:/15022000_egenutvikling_trond_simensen/Spatial_regression/future_hh_areaerver_analyse/correlations_mountains.csv", row.names = FALSE)
